...
class Ui_MainWindow(object):
    ...
    def __init__(self, MainWindow):
        ...
        self.title.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*40, self.width_ratio*141, self.height_ratio*17))
        self.title.setObjectName("title")

        self.lbl_name = QtWidgets.QLabel(self.centralwidget)
        self.lbl_name.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*80, self.width_ratio*81, self.height_ratio*17))
        self.lbl_name.setObjectName("name")
        self.txt_name = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_name.setGeometry(QtCore.QRect(self.width_ratio*150, self.height_ratio*80, self.width_ratio*113, self.height_ratio*25))
        self.txt_name.setObjectName("txt_name")
        self.txt_name.setMaxLength(250)

        self.lbl_code = QtWidgets.QLabel(self.centralwidget)
        self.lbl_code.setGeometry(QtCore.QRect(self.width_ratio*310, self.height_ratio*80, self.width_ratio*81, self.height_ratio*17))
        self.lbl_code.setObjectName("lbl_code")
        self.txt_code = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_code.setGeometry(QtCore.QRect(self.width_ratio*410, self.height_ratio*80, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_category_a.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*110, self.width_ratio*81, self.height_ratio*17))
        self.lbl_category_a.setObjectName("lbl_category_a")
        self.combo_category_A = QtWidgets.QComboBox(self.centralwidget)
        self.combo_category_A.setGeometry(QtCore.QRect(self.width_ratio*150, self.height_ratio*110, self.width_ratio*111, self.height_ratio*25))
        ...
        self.lbl_category_b.setGeometry(QtCore.QRect(self.width_ratio*310, self.height_ratio*110, self.width_ratio*81, self.height_ratio*17))
        self.lbl_category_b.setObjectName("lbl_category_b")
        self.combo_category_B = QtWidgets.QComboBox(self.centralwidget)
        self.combo_category_B.setGeometry(QtCore.QRect(self.width_ratio*410, self.height_ratio*110, self.width_ratio*111, self.height_ratio*25))
        ...
        self.lbl_info_1.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*140, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_1.setObjectName("lbl_info_1")
        self.txt_info1 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info1.setGeometry(QtCore.QRect(self.width_ratio*150, self.height_ratio*140, self.width_ratio*113, self.height_ratio*25))
        self.txt_info1.setObjectName("txt_info1")
        self.txt_info1.setMaxLength(250)

        self.lbl_info_2 = QtWidgets.QLabel(self.centralwidget)
        self.lbl_info_2.setGeometry(QtCore.QRect(self.width_ratio*310, self.height_ratio*140, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_2.setObjectName("lbl_info_2")
        self.txt_info_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info_2.setGeometry(QtCore.QRect(self.width_ratio*410, self.height_ratio*140, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_info_3.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*170, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_3.setObjectName("lbl_info_3")
        self.txt_info_3 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info_3.setGeometry(QtCore.QRect(self.width_ratio*150, self.height_ratio*170, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_info_4.setGeometry(QtCore.QRect(self.width_ratio*310, self.height_ratio*170, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_4.setObjectName("lbl_info_4")
        self.txt_info_4 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info_4.setGeometry(QtCore.QRect(self.width_ratio*410, self.height_ratio*170, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_info_5.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*200, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_5.setObjectName("lbl_info_5")
        self.txt_info_5 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info_5.setGeometry(QtCore.QRect(self.width_ratio*150, self.height_ratio*200, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_info_6.setGeometry(QtCore.QRect(self.width_ratio*310, self.height_ratio*200, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_6.setObjectName("lbl_info_6")
        self.txt_info_6 = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_info_6.setGeometry(QtCore.QRect(self.width_ratio*410, self.height_ratio*200, self.width_ratio*113, self.height_ratio*25))
        ...
        self.lbl_info_7.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*230, self.width_ratio*81, self.height_ratio*17))
        self.lbl_info_7.setObjectName("lbl_info_7")
        self.txt_info_7 = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info_7.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*250, self.width_ratio*471, self.height_ratio*70))
        self.txt_info_7.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.txt_info_7.setObjectName("txt_info_7")

        self.btn_back = QtWidgets.QPushButton(self.centralwidget)
        self.btn_back.setGeometry(QtCore.QRect(self.width_ratio*50, self.height_ratio*350, self.width_ratio*89, self.height_ratio*25))
        self.btn_back.setObjectName("btn_back")
        
        self.btn_addAnother = QtWidgets.QPushButton(self.centralwidget)
        self.btn_addAnother.setGeometry(QtCore.QRect(self.width_ratio*210, self.height_ratio*350, self.width_ratio*111, self.height_ratio*25))
        self.btn_addAnother.setObjectName("btn_addAnother")
        
        self.btn_saveAndReturn = QtWidgets.QPushButton(self.centralwidget)
        self.btn_saveAndReturn.setGeometry(QtCore.QRect(self.width_ratio*370, self.height_ratio*350, self.width_ratio*141, self.height_ratio*25))
        self.btn_saveAndReturn.setObjectName("btn_saveAndReturn")
        
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, self.width_ratio*583, self.height_ratio*22))
